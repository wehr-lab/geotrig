...
opts = detectImportOptions(dataframefilename, 'ExpectedNumVariables', 7, 'ReadVariableNames',true, 'NumHeaderLines',1, 'Delimiter',',', ...
...
%to be fooled by nan columns, not sure why overriding opts doesn't alwasy work 
...
metadata=readtable('metadata_alltrials.csv');
